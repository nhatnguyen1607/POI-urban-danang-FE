      ...
      <main>
        ...
        <section id="for-business" className="ua-container pb-20 lg:pb-24">
          <div className="grid gap-10 rounded-[28px] bg-gradient-to-br from-[#0E2038] via-[#0B3A6E] to-[#0767C8] p-8 lg:grid-cols-2 lg:items-center lg:p-14">
            ...
            <div className="rounded-[22px] bg-white/10 p-5 ring-1 ring-white/15 backdrop-blur"><div className="flex items-center gap-3 rounded-2xl bg-white px-4 py-3.5"><Sparkles size={16} className="text-[#1597E5]" /><p className="text-[14px] text-[#0E2038]">“Khảo sát bằng chứng khu vực cho study café tại Đà Nẵng”</p></div><div className="mt-4 flex flex-wrap gap-2.5">{['Tín hiệu sinh viên', 'Cạnh tranh quan sát được', 'Dữ liệu cần xác minh', 'Gần cụm đại học'].map((item) => <span key={item} className="rounded-full bg-[#DDF3FF]/20 px-4 py-2 text-[13px] font-medium text-white ring-1 ring-white/20">{item}</span>)}</div></div>
          </div>
        </section>
